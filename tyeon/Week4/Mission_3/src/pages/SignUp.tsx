            ...
            <div className="w-[400px]">
                ...
                {step === 1 && (
                    <div className="flex flex-col gap-4 animate-fadeIn">
                        <button className="border rounded-sm w-full h-[50px] relative flex justify-center items-center mb-2">
                        ...
                        <div className="flex flex-col gap-4">
                            <input 
                                {...register("email")} 
                                className="border border-[#ccccccc8] rounded-sm p-[12px] focus:border-[#0879ea] outline-none" 
                                placeholder="이메일 주소" 
                                type="email" 
                            />
                        ...
                        <button 
                            ...
                            className="rounded-sm h-[50px] bg-[#51a4f7] text-white mt-4 disabled:bg-gray-300 font-bold"
                        >
                            다음
                        </button>
                    </div>
                ...
                {step === 3 && (
                    <div className="flex flex-col gap-6 animate-fadeIn items-center">
                        <div className="text-center w-full">
                            <h2 className="text-lg font-bold">거의 다 왔어요!</h2>
                            <p className="text-gray-500 text-sm">사용하실 닉네임을 설정해주세요.</p>
                        </div>

                        {/* 프로필 이미지 UI (Placeholder) */}
                        <div className="relative w-32 h-32">
                            <div className="w-full h-full bg-gray-100 rounded-full flex items-center justify-center border-2 border-dashed border-gray-300 overflow-hidden">
                                <Camera className="text-gray-400" size={32} />
                            </div>
                            <div className="absolute bottom-1 right-1 bg-[#51a4f7] p-2 rounded-full text-white shadow-md cursor-pointer">
                                <Camera size={14} />
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-1">
                            <input 
                                {...register("name")} 
                                className="border border-[#ccccccc8] rounded-sm w-full p-[12px] focus:border-[#0879ea] outline-none text-center text-lg" 
                        ...
                        <button 
                            ...
                            className="rounded-sm w-full h-[50px] bg-[#51a4f7] text-white disabled:bg-gray-300 transition-all font-bold text-lg"
                        >
                            회원가입 완료
                        </button>
                    </div>
