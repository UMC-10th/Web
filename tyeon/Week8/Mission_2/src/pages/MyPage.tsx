...
import type { ReqUpdateMyInfoDto, ResMyInfoDto } from "../types/auth";
...
export default function MyPage() {
    ...
    const handleSave = async () => {
        ...
        if (editBio !== (user?.bio ?? "")) body.bio = editBio || undefined;
        if (avatarFile) {
    ...
    return (
        <div className="flex flex-col items-center w-full py-12 px-4" style={{ background: "#f4f7fb", minHeight: "100%" }}>
            <div
            ...
            >
                ...
                <div className="text-center">
                    ...
                    {user?.bio && (
                        <p className="text-sm mt-2" style={{ color: "#64748b" }}>{user.bio}</p>
                    )}
                </div>
                ...
                <div className="flex gap-3 w-full">
                    ...
                    <button
                        ...
                        style={{ background: logoutMutation.isPending ? "#94a3b8" : "#1d4ed8" }}
                    >
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            <h2 className="text-lg font-bold" style={{ color: "#1e3a8a" }}>프로필 수정</h2>
                            <button
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                style={{ background: updateMutation.isPending ? "#94a3b8" : "linear-gradient(135deg,#1d4ed8,#3b82f6)" }}
                            >
