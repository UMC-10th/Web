...
const fetchLps = async (sort: SortOrder, search: string, cursor?: number): Promise<LpPage> => {
...
export default function Home() {
    ...
    const {
        ...
        queryKey: ["lps", sortOrder, debouncedSearchQuery],
        queryFn: ({ pageParam }) => fetchLps(sortOrder, debouncedSearchQuery, pageParam as number | undefined),
