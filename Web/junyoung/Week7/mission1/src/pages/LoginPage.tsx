        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <input
              ...
              className="h-10 rounded-md border border-gray-600 bg-transparent px-4 text-sm text-white outline-none placeholder-gray-500 focus:border-pink-500"
            />
          </div>
