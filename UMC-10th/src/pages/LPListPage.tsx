  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-[#0f1014] p-8">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-14 h-14 bg-[#FF1493] text-white text-3xl rounded-full shadow-lg hover:opacity-90 transition-opacity flex items-center justify-center z-40"
      >
        +
      </button>

      {isModalOpen && (
        <LPWriteModal onClose={() => setIsModalOpen(false)} />
      )}
